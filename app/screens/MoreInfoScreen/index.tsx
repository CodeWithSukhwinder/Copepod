    ...
    <View style={{flex: 1, backgroundColor: 'black'}}>
            ...
            <TouchableOpacity
              ...
              {fullScreen ? (
                <View style={styles.timingView}>
                  ...
                  />
                  <RegularText>{format(progress.seekableDuration)}</RegularText>
      ...
      <ScrollView style={{flex: 1, marginHorizontal: 20}}>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              SheetManager.show(SHEETS.DownloadQualitySheet);
            }}
            style={styles.button}>
            <AntDesign
              onPress={() => {
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <RegularText>EPISODES</RegularText>
            {view === 1 ? <View style={styles.line}></View> : null}
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
              setView(2);
            }}>
            <RegularText>MORE LIKE THIS</RegularText>
            {view === 2 ? (
        ...
        {view === 1 ? <AllEpisodes /> : null}
        {view === 2 ? <MoreLikeThis /> : null}
      </ScrollView>
    </View>
  );
};
